...
function Body() {
    ...
    function doLoadAddExam() {
        setLoadRightSection("addExam");
    }
    ...
    } else if (loadRightSection === "addExam") {
        rightSectionRenderer = <AddExam />
    ...
    useEffect(() => {
        const sessionData = localStorage.getItem('session_admin_email');
            ...
            <div className="allMenuParent">
                <div className="allMenuLeftSideContainer" id={leftSideContainerParentID} style={{ width: '20%' }}>
                    <div id={leftSideContainerChildID1} style={{ display: 'block' }}>
                        ...
                        <p className="allMenuLeftSideContainerButton" onClick={doLoadAdminProfile}>Admin Profile</p>
                        ...
                        <p className="allMenuLeftSideContainerButton" onClick={doLoadAddExam}>Add Exam</p>
                    </div>
