...
function ViewResult() {
    ...
    async function getAllScheduledExamInfo() {
        try {
            const response = await fetch('http://localhost:8080/get_all_exam_result_admin', {
                method: 'POST',
                headers: {
            ...
            jsonResponse.forEach(obj => {
                ...
                const emailOfStudentWhoGivesExam = obj.emailOfStudentWhoGivesExam;
                ...
                allExamInfo.push(
                    <SingleExamModalForResult
                        ...
                        emailOfStudentWhoGivesExam={emailOfStudentWhoGivesExam}
